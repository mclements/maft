c July 3 2002: 	adding the interaction with later deliveries
c		
c June 13 2002:
...
c
 	subroutine intfetal(param,npar,idata,m1,m2,loglik,prob)
	parameter (nn=15)
...
c if the first pregnancy exists
	  ...
	  call intfetcov(param,npar,n11,n21,n1,n2,correl)
...
c
	subroutine intfetcov(param,npar,n11,n21,n1,n2,correl)
	parameter (nn=15)
...
c		7= late mother effect
c		8= late environment effect
c
	sigm2 = param(3)
	sfet2 = param(4)
	sigs2 = param(5)
